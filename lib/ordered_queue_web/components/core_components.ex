defmodule OrderedQueueWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OrderedQueueWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OrderedQueueWeb.Gettext, "errors", msg, opts)
    end
  end
